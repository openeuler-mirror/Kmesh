...
// Update function for map_of_break_count
int deserial_update_map_of_break_count_elem(void *key, void *value) {
    unsigned int id;
    char *map_name = "map_of_break_count";
    int ret;
    struct bpf_map_info info;
    int map_fd;

    ret = get_map_ids(map_name, &id, NULL, NULL);
    if (ret)
        return ret;
    ...
    ret = bpf_map_update_elem(map_fd, key, value, BPF_ANY);
    if (ret)
        LOG_ERR("update MAP: %s failed\n", map_name);
    close(map_fd);
    return ret;
}

// Delete function for map_of_break_count
int deserial_delete_map_of_break_count_elem(void *key) {
    unsigned int id;
    char *map_name = "map_of_break_count";
    int ret;
    struct bpf_map_info info;
    ...
    ret = bpf_map_delete_elem(map_fd, key);
    if (ret)
        LOG_ERR("delete MAP: %s failed\n", map_name);
    close(map_fd);
    return ret;
}

// Update function for map_of_is_break
int deserial_update_map_of_is_break_elem(void *key, void *value) {
    unsigned int id;
    char *map_name = "map_of_is_break";
    int ret;
    struct bpf_map_info info;
    int map_fd;
...
// Delete function for map_of_is_break
int deserial_delete_map_of_is_break_elem(void *key) {
    unsigned int id;
    char *map_name = "map_of_is_break";
    int ret;
    struct bpf_map_info info;
...
// Update function for map_of_break
int deserial_update_map_of_break_elem(void *key, void *value) {
    unsigned int id;
    char *map_name = "map_of_break";
    int ret;
    struct bpf_map_info info;
    int map_fd;
...
// Delete function for map_of_break
int deserial_delete_map_of_break_elem(void *key) {
    unsigned int id;
    char *map_name = "map_of_break";
    int ret;
    struct bpf_map_info info;
